    ...
    render(){
        ...
        return (
            <View style={styles.container}>
                <Toolbar width={width} title="教练资料" actions={[]} navigator={this.props.navigator}>
                    <View style={{flexDirection:'column'}}>
                        ...
                        <View style={{marginTop:3,justifyContent:'center'}}>
                            ...
                            <View style={{width:width,height:320,padding:10,backgroundColor:'#fff',flexDirection:'column'}}>
                        ...
                        {/*出生日期*/}
                            ...
                            {/*身高体重*/}
                                ...
                                <View style={{flex:1,padding:12,paddingHorizontal:10,paddingTop:4,flexDirection:'row'}}>
                                    ...
                                    <View style={{alignItems:'center',justifyContent:'flex-end'}}>
                                        {
                                            this.state.member.coachLevel&&this.state.member.coachLevel!=''?
                                                <Text style={{color:'#444',fontSize:15}}>
                                                    {this.state.member.coachLevel}
                                                </Text>:
                                                <Text style={{color:'#777',fontSize:15}}>
                                                    未设置
                                                </Text>
                                ...
                                <View style={{flex:1,padding:12,paddingHorizontal:10,paddingTop:4,flexDirection:'row'}}>
                                    ...
                                    <View style={{alignItems:'center',justifyContent:'flex-end'}}>
                                        {
                                            this.state.member.sportLevel&&this.state.member.sportLevel!=''?
                                                <Text style={{color:'#444',fontSize:15}}>
                                                    {this.state.member.sportLevel}
                                                </Text>:
                                                <Text style={{color:'#777',fontSize:15}}>
                                                    未设置
                                                </Text>
